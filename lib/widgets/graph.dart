...
class GraphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint linePaint = Paint()
      ..color = const ui.Color.fromARGB(121, 104, 136, 109)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 2.0;

    Paint shadowPaint = Paint()
      ..color = const ui.Color.fromARGB(0, 26, 251, 157)
      ..style = PaintingStyle.stroke
    ...
    Paint fillPaint = Paint()
      ..shader = ui.Gradient.linear(
        ...
        [
          const ui.Color.fromARGB(255, 3, 255, 108),
          const ui.Color.fromARGB(111, 255, 255, 255)
        ],
      )
    ...
    Paint dotCenter = Paint()
      ..color = const ui.Color.fromARGB(255, 31, 255, 64)
      ..strokeWidth = 8;
